                            ...
                            <div className="flex justify-between ">
                                ...
                                <div className="flex items-center  gap-2">
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        <h1 className="text-xs font-semibold text-gray-300">{assignment.project !== undefined ? assignment.project.name : ""}</h1>
                                        <div><ArrowRightIcon className="h-4 "></ArrowRightIcon></div>
                                        <h1 className="text-xs">{assignment.updatedAt ? formatDateUTC(String(assignment.updatedAt)) : "No deadline"}</h1>
                                    </div>
                                </div>
